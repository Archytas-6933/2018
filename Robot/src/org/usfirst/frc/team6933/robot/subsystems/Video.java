...
public class Video extends Subsystem {
	...
	public void startAutomaticCapture() {
		...
		//server.startAutomaticCapture();
		 ...
		 DriverStation.reportWarning("Can't open front-facing camera: "+e.getMessage(), false);
		 ...
		 DriverStation.reportWarning("Can't open overhead camera: "+e.getMessage(), false);
		 }
	}
